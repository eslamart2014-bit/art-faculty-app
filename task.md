...
- [x] **Task 2**: Ensure the Warning report ("إنذار") in `attendance/page.tsx` and the PDF reports from `reports/page.tsx` include the University and Faculty header ("جامعة قنا", "كلية التربية النوعية", "قسم التربية الفنية").
